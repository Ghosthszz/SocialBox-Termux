...
echo -e " $blue v2.beta$nc"
echo ""
echo -e "$yellow Select From Menu : $nc"
echo ""
echo -e "		$Cyan 1 : Brute Force Conect$nc"
echo -e "		$Cyan 2 : NEW terminal$nc"
echo -e "		$Cyan 3 : section active 1$nc"
echo -e "		$Cyan 4 : msg box termil$nc"
echo -e "		$Cyan 5 : termux attack 2 $nc"
